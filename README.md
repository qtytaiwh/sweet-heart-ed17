...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/sweet-heart-ed17)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/sweet-heart-ed17
```

A live public deployment of this template is available at [https://sweet-heart-ed17.templates.workers.dev](https://sweet-heart-ed17.templates.workers.dev)
